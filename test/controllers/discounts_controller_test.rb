...
class DiscountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discount" do
    assert_difference('Discount.count') do
      post discounts_url, params: { discount: { coupon: @discount.coupon, discount_type: @discount.discount_type, recurring: @discount.recurring, value: @discount.value } }
    end
  ...
  test "should update discount" do
    patch discount_url(@discount), params: { discount: { coupon: @discount.coupon, discount_type: @discount.discount_type, recurring: @discount.recurring, value: @discount.value } }
